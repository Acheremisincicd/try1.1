 ...
 */
public class UserService extends AbstractIEntityService<User, UserDao> implements IUserService {

    public UserService(UserDao dao, TransactionDispatcher transactionDispatcher) {
